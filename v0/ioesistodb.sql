...
--
-- Host: localhost
-- Generato il: 15 ago, 2010 at 03:45 PM
...
CREATE TABLE IF NOT EXISTS `Post` (
  ...
  `ps_creatonDate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
--
-- Struttura della tabella `ContestSubscriber`
--
DROP TABLE IF EXISTS `ContestSubscriber`;
...
--
-- Struttura della tabella `MailDirectory`
--
...
--
-- Struttura della tabella `MailOfDirectory`
--
DROP TABLE IF EXISTS `MailOfDirectory`;
