...
CREATE TABLE IF NOT EXISTS `" . TABLE_NATION . "` (
...
CREATE TABLE IF NOT EXISTS `" . TABLE_REGION . "` (
  ...
  `" . REGION_NATION . "` varchar(100) NOT NULL,
  PRIMARY KEY (`" . REGION_ID . "`),
  KEY `" . REGION_NATION_FKEY . "` (`" . REGION_NATION . "`),
  FOREIGN KEY (`" . REGION_NATION . "`) REFERENCES `" . TABLE_NATION . "` (`" . NATION_NAME . "`) ON DELETE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=1;

CREATE TABLE IF NOT EXISTS `" . TABLE_PLACE . "` (
  `" . PLACE_ID . "` bigint(20) NOT NULL AUTO_INCREMENT,
  `" . PLACE_NAME . "` varchar(100) NOT NULL,
  `" . PLACE_REGION . "` bigint(20) NOT NULL,
  PRIMARY KEY (`" . PLACE_ID . "`),
  KEY `" . PLACE_REGION_FKEY . "` (`" . PLACE_REGION . "`),
  FOREIGN KEY (`" . PLACE_REGION . "`) REFERENCES `" . TABLE_REGION . "` (`" . REGION_ID . "`) ON DELETE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=1;
...
CREATE TABLE IF NOT EXISTS `" . TABLE_LOG . "` (
  ...
  PRIMARY KEY (`" . LOG_ID . "`),
  KEY `" . LOG_USER_FKEY . "` (`" . LOG_USER . "`),
  FOREIGN KEY (`" . LOG_USER . "`) REFERENCES `" . TABLE_USER . "` (`" . USER_ID . "`) ON DELETE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
